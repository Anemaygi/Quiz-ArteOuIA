...
const QuizTips: React.FC<QuizOnboardingProps> = ({ next }) => {
  ...
  return (
    <div className="h-full w-full p-2 grid-cols-1 grid lg:grid-cols-3 gap-4">
      ...
      <div className="w-full overflow-y-auto h-screen lg:h-full bg-gradient-to-b rounded-lg shadow-md from-[#282828] flex flex-col md:hover:bg-gradient-to-b items-center justify-center md:hover:from-[#313131] transition-all ease-in-out md:hover:duration-300 p-8 group">
