        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 m-8 h-full items-center ">
          ...
          <div className="my-8">
            ...
            <div className="flex justify-center items-center lg:justify-start mt-4">
              <div className="w-44"><Button text="Quiz" handleClick={() => console.log('oi')} /></div>
              <p className="cursor-pointer text-lg px-6 hover:scale-105">Entenda</p>
            </div>
          </div>
          <div>

            <img className="z-50 xl:absolute bottom-0 right-0 h-full pt-8" src="https://i.imgur.com/76p3Ip6.png" />
          </div>
